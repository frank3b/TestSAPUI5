sap.ui.jsview("com.products.SupplierDetail", {

    getControllerName : function() {
		return "com.products.SupplierDetail";
    },
	/**
    ...
    createContent : function(oController) {
		this.oList = new sap.m.List({
	    	...
	    	items : [
				  	  new sap.m.DisplayListItem({ label : oBundle.getText("BUSINESSPARTNER_CITY"), value : "{City}"}),
 				  	  ...
 				  	  new sap.m.DisplayListItem({ label : oBundle.getText("BUSINESSPARTNER_COUNTRY"), value : "{Country}"}),
		...
		this.oNavList = new sap.m.List({
	    	...
	    	items : [ new sap.m.DisplayListItem({
				type : "Navigation",
				label : oBundle.getText("TITLE__SALES_ORDER"),
