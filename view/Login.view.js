...
sap.ui.jsview("com.opensap.Login", {
	...
	/* 
	 * For simplicity I have named the controller the same as the view
	 * However there are cases where multiple views will use the same controller
	 * Effectively I could have implemented the entire application with one controller but that
	 * would not be best practice IMHO
	 */
